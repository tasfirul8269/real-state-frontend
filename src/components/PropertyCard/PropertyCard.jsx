...
const PropertyCard = ({ property, loading, error }) => {
  ...
  return (
    <div
    to="/property-details"
    className="container mx-auto p-0 bg-white rounded-xl animate__animated animate__fadeIn grid md:grid-cols-2 gap-4 border border-spacing-0.5 border-gray-200 my-6 h-[40vh] shadow-xl overflow-hidden"
  >
