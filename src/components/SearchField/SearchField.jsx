...
const SearchField = () => {
    ...
    return (
        <form className='flex flex-col md:flex-row gap-4 justify-center items-center py-4'>
            ...
            <button onClick={(e) => e.preventDefault()} className='cursor-pointer px-16 md:px-8 py-4 text-gray-400 bg-[#f6f6f1] rounded-md hover:border border-black'>Buy</button>
            <button onClick={(e) => e.preventDefault()} className='cursor-pointer px-16 md:px-8 py-4 text-gray-400 bg-[#f6f6f1] rounded-md hover:border border-black'>Rent</button>
            </div>
