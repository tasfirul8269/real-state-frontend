...
const PropertyValuation = () => {
    return (
        <div className='flex justify-between items-center gap-8 bg-linear-to-b from-[#E00404] to-[#FF8383] p-20  px-[50px] mx-auto rounded-2xl mb-[20px]'>
            <div>
        ...
        <button className='py-3 px-5 rounded-2xl bg-[#FF6D6D] text-white hover:bg-red-500 cursor-pointer w-1/4'>Get Started</button>
        </div>
    );
};
