import { FaPhone, FaWhatsapp, FaMapMarkerAlt, FaCalendarAlt, FaMoneyBillWave, FaBuilding } from 'react-icons/fa';
import 'animate.css';
...
const OffPlanProperties = () => {
  ...
  return (
    <div className=" px-4 py-12 animate__animated animate__fadeIn">
      <h1 className="text-3xl font-bold text-[#083819] mb-6">Browse our Off Plan properties</h1>
            ...
            <div className="">
              ...
              <div className="space-y-3 my-4">
                <p className="text-gray-700 text-xs flex items-center">
                  ...
                  <span className="font-bold">Delivery:{" "} </span> {property.deliveryDate}
                </p>
                <p className="text-gray-700 text-xs flex items-center">
                  <FaMoneyBillWave className="mr-2" />
                  <span className="font-bold">Price from:{" "} </span> {property.price}
                </p>
                <p className="text-gray-700 text-xs flex items-center">
                  <FaBuilding className="mr-2" />
                  <span className="font-bold">Developer:{" "}</span> {property.developer}
                </p>
              </div>
